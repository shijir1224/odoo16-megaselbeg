openerp.hse.daily = function(instance) {
    ...
    instance.hse.daily_report = instance.web.form.FormWidget.extend(instance.web.form.ReinitializeWidgetMixin, {
        init: function() {
            ...
            this.field_manager.on("field_changed:branch_ids", this, function() {
                this.set({"branchs": this.field_manager.get_field_value("branch_ids")});
            });
        ...
        initialize_field: function() {
            ...
            self.on("change:branchs", self, self.initialize_content);
        },
        ...
        initialize_content: function() {
            ...
            var branchs = self.get('branchs')[0][2];
            var man_hour;
            var man_day;
            var branch_name;
            var injury_month;
            ...
            var rate_obj;
            return new instance.web.Model("hse.daily.report").call("get_injury", [date,branchs,new instance.web.CompoundContext()])
            .then(function(details) {
                injury_month = details.month;
                injury_ytd = details.ytd;
                return new instance.web.Model("hse.daily.report").call("get_lost_time", [date,branchs,new instance.web.CompoundContext()])
                .then(function(details) {
                    lost_time_month = details.month;
                    lost_time_ytd = details.ytd;
                    return new instance.web.Model("hse.daily.report").call("get_injury_detail", [date,branchs,new instance.web.CompoundContext()])
                    .then(function(details) {
                        all_injury = details;
                        accident_type = details.all_accident;
                        return new instance.web.Model("hse.daily.report").call("get_nope_lti", [date,branchs,new instance.web.CompoundContext()])
                        .then(function(details) {
                            man_hour = details.inc_man_hour;
                            man_day = details.inc_total_day;
                            incident_rate = details;
                            return new instance.web.Model("hse.daily.report").call("get_all_hse", [date,branchs,new instance.web.CompoundContext()])
                            .then(function(details) {
                                all_hse = details;
                                return new instance.web.Model("hse.safety.report").call("get_bird_pyramid", [date,branchs,new instance.web.CompoundContext()])
                                .then(function(details) {
                                    bird_pyramid_obj = details;
                                    return new instance.web.Model("hse.safety.report").call("get_rate", [date, date,branchs,new instance.web.CompoundContext()])
                                    .then(function(details) {
                                        rate_obj = details;
                                    });
                                }); 
        ...
        get_all_hse: function(branch_name, desc, obj, locations){
            var  sampleData = obj;
            var series = []
        ...
        display_data: function() {
            ...
            try {
                ...
                for (var i=0; i<self.all_hse.length; i++){
                    $('#hutlugch'+self.all_hse[i].branch_id).jqxChart(self.get_all_hse(self.all_hse[i].branch_name, _t("Leading indicators"), self.all_hse[i].hutlugch, self.all_hse[i].locations));
                    $('#hutlugch'+self.all_hse[i].branch_id).jqxChart('addColorScheme', 'customColorScheme', 
                        ['#82dd7f', '#39abc3','#fbcb03','#d5ddff','#fd635a','#ee8c3f','#d7e753','#BBDAF6','#DEC990','#dfdce3']);
                    $('#hutlugch'+self.all_hse[i].branch_id).jqxChart({ colorScheme: 'customColorScheme' });

                    $('#survaljit'+self.all_hse[i].branch_id).jqxChart(self.get_all_hse(self.all_hse[i].branch_name, _t("Lagging indicators"), self.all_hse[i].survaljit, self.all_hse[i].locations));
                    $('#survaljit'+self.all_hse[i].branch_id).jqxChart('addColorScheme', 'customColorScheme', 
                        ['#82dd7f', '#39abc3','#fbcb03','#d5ddff','#fd635a','#ee8c3f','#d7e753','#BBDAF6','#DEC990','#dfdce3']);
                    $('#survaljit'+self.all_hse[i].branch_id).jqxChart({ colorScheme: 'customColorScheme' });
                }
