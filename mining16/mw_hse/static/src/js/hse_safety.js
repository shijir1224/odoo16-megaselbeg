openerp.hse.safety = function(instance) {
    ...
    instance.hse.safety_report = instance.web.form.FormWidget.extend(instance.web.form.ReinitializeWidgetMixin, {
        ...
        initialize_content: function() {
            ...
            var plan_actual_obj;
            return new instance.web.Model("hse.safety.report").call("get_man_hour", [start_date, end_date,branchs,new instance.web.CompoundContext()])
            .then(function(details) {
                main_obj = details;
                return new instance.web.Model("hse.safety.report").call("get_rate", [start_date, end_date,branchs,new instance.web.CompoundContext()])
                .then(function(details) {
                    rate_obj = details;
                    return new instance.web.Model("hse.safety.report").call("get_bird_pyramid", [end_date,branchs,new instance.web.CompoundContext()])
                    .then(function(details) {
                        bird_pyramid_obj = details;
                        return new instance.web.Model("hse.safety.report").call("get_indicator", [start_date, end_date,branchs,new instance.web.CompoundContext()])
                        .then(function(details) {
                            indicator_obj = details;
                            return new instance.web.Model("hse.safety.report").call("get_reclamation", [start_date, end_date,branchs,new instance.web.CompoundContext()])
                            .then(function(details) {
        ...
        get_safe_day: function(){
            ...
            for (var i=0; i<self.main_obj.man_hour.length; i++){
                series.push({dataField: self.main_obj.man_hour[i].branch_name, displayText: self.main_obj.man_hour[i].branch_name})
            }
                    ...
                    [
                        {
                            ...
                            series: [
                                    ...
                                    { dataField: 'hse_workplace_inspection', displayText: _t('WPI') },
        ...
        display_data: function() {
            ...
            try {
                ...
                $('#reclamation_chart').jqxChart('addColorScheme', 'customColorScheme', ['#9bbf8f','orange','MediumBlue']);
                $('#reclamation_chart').jqxChart({ colorScheme: 'customColorScheme' });  
            }
            catch(err) {
