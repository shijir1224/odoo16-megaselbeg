openerp.hse = function(instance) {
    ...
    instance.hse.corrective_actions = instance.web.form.FormWidget.extend(instance.web.form.ReinitializeWidgetMixin, {
        ...
        initialize_content: function() {
            ...
            var branchs;
            var all_details;
            branchs = self.get('branchs')[0][2];
            var set_date_from = self.get('start_date');
            var set_date_to = self.get('end_date');
            return new instance.web.Model("hse.corrective.actions").call("get_all", [set_date_from,set_date_to,branchs,new instance.web.CompoundContext()])
        ...
        get_datatable: function(res){
            ...
            var linkrenderer = function (index, datafield, value, defaultvalue, column, rowdata) {
                ...
                if (data[index].uzuulelt==_t('Workplace inspection')){
            ...
            var settings_datatable= {
                ...
                columns: [
                    ...
                    {
                        text: _t('Project'), align: 'center', dataField: 'branch', width:80, cellsrenderer:linkrenderer
                    },                
                ],
        ...
        display_data: function() {
            ...
            try {
                ...
                $('#workplace_inspection').jqxChart(self.get_donut(self.all_details.workplace_done,self.all_details.workplace_not_done));
                $('#workplace_inspection').jqxChart('addColorScheme', 'customColorScheme', ['#2d7b29', '#dc2e58']);
                $('#workplace_inspection').jqxChart({ colorScheme: 'customColorScheme' });
