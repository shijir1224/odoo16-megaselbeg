odoo.define('twb_gantt_view.GanttModel', function (require) {
    "use strict";
    ...
    var GanttModel = AbstractModel.extend({
        ...
        _fetchData: function () {
            ...
            var context = Object.assign({}, this.context, {
                ...
                datee: this.convertToServerTime(this.ganttData.startDate)
            });
            var groupsDef;
        ...
        _updateUnavailabilityRows: function (original, enriched) {
            ...
            _.zip(original, enriched).forEach(function (rowPair) {
                ...
                o.unavailabilities = _.map(e.unavailabilities, function (u) {
                    ...
                    u.start = self._parseServerValue({
                        type: 'datetime'
                    }, u.start);
                    u.stop = self._parseServerValue({
                        type: 'datetime'
                    }, u.stop);
                    return u;
                });
        ...
        _getFields: function () {
            ...
            this.decorationFields.push('additional_ro_ids');
            //console.log('this.decorationFields ',this.decorationFields);
