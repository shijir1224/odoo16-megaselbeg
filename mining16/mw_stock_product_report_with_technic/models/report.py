...
class TechnicEquipmentInherit(models.Model):
    ...
    stock_move_ids = fields.One2many('stock.move', 'technic_id', readonly=True, string=u'Хөдөлгөөн', domain=[('state','=','done')])
    account_move_line_ids = fields.One2many('account.move.line', 'technic_id', readonly=True, string=u'Санхүү Хөдөлгөөн')
    ...
    def see_parts(self):
        action = self.env.ref('mw_stock_product_report_with_technic.technic_stock_move_action').read()[0]
