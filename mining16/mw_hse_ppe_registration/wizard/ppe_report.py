...
class ppeTtctReport(models.Model):

	_name = 'ppe.granted.report'
	_description = 'ppe Report'
	...
	def export_report(self):
		...
		rowx=0
		save_row=0
		sheet.merge_range(rowx+1,0,rowx+1,12, u'PPE олголтын тайлан/PPE supply report', theaderl),
		...
		query="""SELECT 
			...
			WHERE  ppel.date >= '%s' and  ppel.date <= '%s'
