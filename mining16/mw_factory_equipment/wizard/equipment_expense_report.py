...
# Plan material line
class EquipmentExpenseReport(models.Model):
	_name = "equipment.expense.report"
	...
	equipment_id = fields.Many2one('factory.equipment', string=u'Тоног төхөөрөмж', readonly=True, )
...
# WO move lines
class EquipmentWOExpenseReport(models.Model):
	_name = "equipment.wo.expense.report"
