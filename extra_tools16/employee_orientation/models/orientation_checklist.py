...
class OrientationChecklist(models.Model):
    ...
    checklist_department_id = fields.Many2one('hr.department', string='Department', required=False)
    checklist_department_ids = fields.Many2many('hr.department', string='Department', required=True)
