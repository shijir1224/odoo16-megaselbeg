odoo.define('mw_pos.DuplicateReceipt', function(require) {
    'use strict';

    const PosComponent = require('point_of_sale.PosComponent');
    const Registries = require('point_of_sale.Registries');

    class DuplicateReceipt extends PosComponent {
        constructor() {
            super(...arguments);
    ...
    DuplicateReceipt.template = 'DuplicateReceipt';

    Registries.Component.add(DuplicateReceipt);
