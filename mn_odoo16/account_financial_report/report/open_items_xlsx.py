...
class OpenItemsXslx(models.AbstractModel):
    ...
    def write_ending_balance_from_dict(
        ...
        if type_object == "partner":
            ...
            my_object["amount_residual_currency"] = total_amount[account_id][partner_id]["amount_residual_currency"]
            label = _("Partner ending balance")
        elif type_object == "account":
            name = my_object["code"] + " - " + my_object["name"]
            my_object["residual"] = total_amount[account_id]["residual"]
            my_object["amount_residual_currency"] = total_amount[account_id]["amount_residual_currency"]
            label = _("Ending balance")
        # if my_object.get('currency_name',False):
        #     print('12312q ',total_amount[account_id]["amount_residual_currency"])
        #     print ('111 ',report_data["row_pos"])
        #     report_data["sheet"].write_number(
        #                 report_data["row_pos"],
        #                 10,
        #                float(total_amount[account_id]["amount_residual_currency"]),
        #                 report_data["formats"]["format_header_right"],
        #             )
        
        #     print ('aaaaa ',report_data["row_pos"])
        #     report_data["sheet"].write_formula(report_data["row_pos"], 10, '{=SUM('+self._symbol(report_data["row_pos"], 10) +':'+ self._symbol(report_data["row_pos"]-1, 5)+')}', report_data["formats"]["format_header_amount"],)
