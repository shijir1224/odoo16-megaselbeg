...
class GeneralLedgerReportWizard(models.TransientModel):
    ...
    centralize = fields.Boolean(string="Activate centralization", default=False)
    ...
    show_few_fields = fields.Boolean(
        string="Илүү талбар харуулах?",
        default=False,
    )
    ...
    def _prepare_report_general_ledger(self):
        ...
        return {
            ...
            "show_few_fields":self.show_few_fields,
