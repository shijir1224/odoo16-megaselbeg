...
class AccountPaymentExpense(models.TransientModel):
    ...
    account_id = fields.Many2one('account.account', 'Expense Account', default=_default_ex_account_id)
    analytic_id = fields.Many2one('account.analytic.account', 'Analytic', )
    date = fields.Date('Date', readonly=True, default=time.strftime('%Y-%m-%d'))
    ...
    # cash_type_id = fields.Many2one('account.cash.move.type', default=_default_cash_type_id)
    invoice_id = fields.Many2one('account.move', default=_default_invoice_id)
    journal_id = fields.Many2one('account.journal', 'Journal', default=_default_journal_id,
